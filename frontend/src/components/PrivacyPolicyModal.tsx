    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Datenschutzerklärung">
      <div className="space-y-4 text-sm text-gray-700 max-h-[70vh] overflow-y-auto px-1">
        <p>
          ...
          <br />
          Neighborly Ltd., Beispielstraße 12, 12345 Berlin
          <br />
        ...
        <p>
          ...
          <br />
          Name, E-Mail, Adresse; freiwillige Standortfreigabe;
          Nutzungsaktivitäten
        </p>
        ...
        <p>
          ...
          <br />
          Vermittlung von Hilfe, Kommunikation, Verbesserung der App
        </p>

        <p>
          <strong>3a. Rechtsgrundlagen</strong>
          <br />
          DSGVO Art. 6 Abs. 1 lit. a, b, f
        </p>

        <p>
          <strong>4. Weitergabe von Daten</strong>
          <br />
          Keine Weitergabe ohne Einwilligung – außer gesetzlich erforderlich
        </p>
        ...
        <p>
          <strong>6. Rechte der Betroffenen</strong>
          <br />
          Auskunft, Berichtigung, Löschung, Widerspruch, etc.
        </p>

        <p>
          <strong>7. Sicherheit</strong>
          <br />
